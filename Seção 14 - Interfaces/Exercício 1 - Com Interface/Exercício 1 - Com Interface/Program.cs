...
using Exercício_1___Com_Interface.Services;

namespace Exercício_1___Com_Interface
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            RentalService rentalservice = new RentalService(valueHour, valueDay, new BrazilTaxService());
